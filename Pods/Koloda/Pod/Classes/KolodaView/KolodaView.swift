...
open class KolodaView: UIView, DraggableCardDelegate {
    ...
    // Opacity values
    @objc public var alphaValueOpaque = defaultAlphaValueOpaque
    @objc public var alphaValueTransparent = defaultAlphaValueTransparent
    @objc public var alphaValueSemiTransparent = defaultAlphaValueSemiTransparent
    @objc public var shouldPassthroughTapsWhenNoVisibleCards = false
    ...
    // Animation durations
    @objc public var appearanceAnimationDuration = defaultAppearanceAnimationDuration
    @objc public var backgroundCardFrameAnimationDuration = defaultBackgroundCardFrameAnimationDuration
    @objc public var reverseAnimationDuration = defaultReverseAnimationDuration
    
    @objc public var countOfVisibleCards = defaultCountOfVisibleCards
    @objc public var backgroundCardsTopMargin = defaultBackgroundCardsTopMargin
    @objc public var backgroundCardsScalePercent = defaultBackgroundCardsScalePercent
    ...
    @objc internal var shouldTransparentizeNextCard: Bool {
    ...
    @objc internal func frameForTopCard() -> CGRect {
    ...
    @objc internal func moveOtherCardsWithPercentage(_ percentage: CGFloat) {
    ...
    @objc func card(cardWasReset card: DraggableCardView) {
    ...
    @objc func card(cardWasTapped card: DraggableCardView) {
    ...
    @objc func card(cardShouldDrag card: DraggableCardView) -> Bool {
    ...
    @objc func card(cardPanBegan card: DraggableCardView) {
        delegate?.kolodaPanBegan(self, card: card)
    }

    @objc func card(cardPanFinished card: DraggableCardView) {
    ...
    @objc public func reconfigureCards() {
        if dataSource != nil {
            for (index, card) in visibleCards.enumerated() {
