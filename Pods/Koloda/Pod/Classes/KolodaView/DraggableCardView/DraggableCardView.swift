...
public class DraggableCardView: UIView, UIGestureRecognizerDelegate {
    ...
    //Drag animation constants
    @objc public var rotationMax = defaultRotationMax
    @objc public var rotationAngle = defaultRotationAngle
    @objc public var scaleMin = defaultScaleMin
    ...
    @objc internal var dragBegin = false
    ...
    //MARK: Configurations
    @objc func configure(_ view: UIView, overlayView: OverlayView?) {
